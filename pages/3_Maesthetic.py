...
st.image("images/20250523_180607.png", caption="Amo amarte, Evelyn Mora Ortega, dame tu apellidoOoo", width=350)
st.divider()
st.image("images/20250620_154045.png", caption="Con cariño, Popel")
