...
st.divider()
st.image("otraPrueba/images/20250103_125111.png", caption="El primer día que pasamos juntos", width=350)
...
st.image("otraPrueba/images/imagen2.png", caption="OJITO con la escala del eje y.", width=796)

show_chart = st.checkbox("Pícale aquí: ")

if show_chart:
    st.image("otraPrueba/images/grafica2.png", width=796)
...
st.image("otraPrueba/images/20250103_205911.png", caption="La mejor cena que había tenido, y no fue el lugar, fue que dormí contigo después de eso.", width=350)
...
st.image("otraPrueba/images/20250118_130029.png", caption="Tengo recuerdos muy lindos de ti en Tepo.", width=350)
...
""")
st.image("otraPrueba/images/20250125_130017.png", caption="Es un espectáculo amarte.", width=350)

st.markdown("¿Ya te dije que te amo, evelyn?")


st.image("otraPrueba/images/20250418_191357.png", caption="Quiero seguir formando recuerdos contigo.")