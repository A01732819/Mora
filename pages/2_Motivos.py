...
with col1:
    ...
    st.image("otraPrueba/images/20250110_170306.png", caption="La vida siendo tan hermosa como matemática.", width=350)
...
with col2:
    ...
    """)
    st.image("otraPrueba/images/20250502_185248.png", caption="El número de oro también está en la geometría.")
...
with col1:
    ...
    st.image("otraPrueba/images/20250214_133714.png", caption="Hasta lo que parece pequeño, tiene infinito detalle.", width=350)
...
with col2:
    ...
    """)
    st.image("otraPrueba/images/20250609_180938.jpg", caption="Agradezco todos los días de poder conocerte más y más.", width=350)
...
with col1:
    ...
    st.image("otraPrueba/images/20250214_143813.png", caption="Siempre hay otras maneras de ver la vida.", width=350)
...
with col2:
    ...
    """)
    st.image("otraPrueba/images/20250515_160620.png", caption="Una carta de pokemon tiene muchas representaciones, todas son bonitas, pero al final del día, es una carta pokemon. Y tú eres mi favorita.", width=350)
...
with col1:
    ...
    st.image("otraPrueba/images/20250304_181511.png", caption="¿Te imaginaste alguna vez así conmigo?", width=350)
with col2:
    st.subheader("¿Cómo se relaciona contigo?")
    st.markdown("""
    ...
    """)
    st.image("otraPrueba/images/20250418_193733.jpg", caption="Neta que me la paso bien padre cuando te tengo cerca.")
...
st.image("otraPrueba/images/20250322_184225.png", caption="Todo es todo.", width=350)
