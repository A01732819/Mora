...
st.image("otraPrueba/images/20241101_210832.png", caption="Esta carta también es un viaje por el tiempo.", width=350)
...
st.image("otraPrueba/images/20241113_214825.png", caption="Una de las tantas lunas que han visto nuestro amor.",width=350)
...
with col1:
    st.image("otraPrueba/images/20241206_162743.png", caption="Este día fue muy lindo.")

with col2:
    st.image("otraPrueba/images/20241206_130235.png", caption="Fue la primera vez que pude sentir tu calidez.")
...
st.image("otraPrueba/images/20241209_141614.png", caption="Foto de nuestro primer beso<33", width=350)
...
st.image("otraPrueba/images/20241226_135757.jpg", caption="No supe cómo voltear la imagen (xd), ¿Ya te dije que te amo?", width=350)
